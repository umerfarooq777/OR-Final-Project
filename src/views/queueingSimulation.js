...
function QueueingSimulation() {
  ...
  var IAVarianceCal = (IAVarianceMax-IAVarianceMin)/12
  var STVarianceCal = (STVarianceMax-STVarianceMin)/12
  ...
  //   // }
  // }, [IAType,IAMean,IAVariance,STType,STMean,STVariance]);
                ...
                <Form>
                  ...
                  <Row>
                    <Col className="pr-1" md="5">
                      <p className="labelHeading"> <i className="nc-icon nc-notes "></i> Inter Arrival Distribution</p>
                      <Form.Select name="interArrivalDistribution" className="mb-3 customSelect" 
                      value={IAType}
                      ...
                      <Form.Control
                        ...
                        className="mb-3"
                        value={IAMean}
                        onChange={(e)=>{setIAMean(e.target.value)}}
                      ></Form.Control>

                    {IAType=="exponential" || IAType=="" ?null:(<>
                      <p>Variance of Inter Arrival (	&sigma;<sup>2</sup><sub>a</sub> ) : <span className="text-info">{IAVarianceMax&&IAVarianceMin?"("+IAVarianceCal.toFixed(4)+")":null}</span></p>
<Row>
  <Col md="6"><Form.Control
                        ...
                        width="80%"
                        value={IAVarianceMax}
                        onChange={(e)=>{setIAVarianceMax(e.target.value)}}
                      ></Form.Control>
                      </Col>
  <Col md="6"><Form.Control
                        ...
                        width="80%"
                        value={IAVarianceMin}
                        onChange={(e)=>{setIAVarianceMin(e.target.value)}}
                      ></Form.Control></Col>
  </Row>
                    ...
                    <Col className="pr-1" md="5">
                      <p className="labelHeading">  <i className="nc-icon nc-notes"></i> Service Time Distribution</p>
                      <Form.Select name="serviceTimeDistribution" className="mb-3 customSelect"
                      value={STType}
                      ...
                      <Form.Control
                        ...
                        className="mb-3"
                        value={STMean}
                        onChange={(e)=>{setSTMean(e.target.value)}}
                      ></Form.Control>

                      {
                        STType=="exponential" || STType=="" ?null:(
                        <>
                        <p>Variance of Service Time (	&sigma;<sup>2</sup><sub>s</sub> ) : <span className="text-info">{STVarianceMax&&STVarianceMin?"("+STVarianceCal.toFixed(4)+")":null}</span></p>
                          <Row>
                            <Col md="6"><Form.Control
                          placeholder="Maximum Value"
                          type="number"
                          width="80%"
                          value={STVarianceMax}
                          onChange={(e)=>{setSTVarianceMax(e.target.value)}}
                          ></Form.Control></Col>
                            <Col md="6"><Form.Control
                          placeholder="Minimum Value"
                          type="number"
                          width="80%"
                          value={STVarianceMin}
                          onChange={(e)=>{setSTVarianceMin(e.target.value)}}
                          ></Form.Control></Col>
                          </Row>
                 ...
                 <Row>
                  ...
                  <Col className="pl-1" md="4">
                    ...
                    <Button
                      className="btn-fill pull-right"
                      variant="info"
                      onClick={(e)=>{Calculate1(e)}}
                      >
                      Simulation 1 [ {IAType==''?"_":IAType=="exponential"?"M":"G"}\{STType==''?" _":STType=="exponential"?"M":"G"}\{server} ]
                    </Button>
                    :IAType=="exponential"&&STType!=="exponential"? 
                    <Button
                      className="btn-fill pull-right"
                      ...
                      >
                      Simulation 2 [ {IAType==''?"_":IAType=="exponential"?"M":"G"}\{STType==''?" _":STType=="exponential"?"M":"G"}\{server} ]
                    </Button>
                    :
                    <Button
                      className="btn-fill pull-right"
                      ...
                      >
                      Simulation 3 [ {IAType==''?"_":IAType=="exponential"?"M":"G"}\{STType==''?" _":STType=="exponential"?"M":"G"}\{server} ]
                    </Button>
                      }

                     
                  </Col>
                  <Col className="pl-1" md="4"><div className="clearfix"></div></Col>
                 </Row>
          ...
          <Col md="6">
            <Card className="card-stats">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats">
                <Card.Title as="h4">{LqCal?LqCal:"--"}<span className="units">{units}</span></Card.Title>
          ...
          <Col md="6">
            <Card className="card-stats">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats">
                <Card.Title as="h4">{WqCal?WqCal:"--"}<span className="units">{units}</span></Card.Title>
          ...
          <Col md="6">
            <Card className="card-stats">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats">
                <Card.Title as="h4">{WsCal?WsCal:"--"}<span className="units">{units}</span></Card.Title>
          ...
          <Col md="6">
            <Card className="card-stats">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats">
                <Card.Title as="h4">{LCal?LCal:"--"}<span className="units">{units}</span></Card.Title>
          ...
          <Col md="12">
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  <Col xs="7">
                      ...
                      <h1 className="answer-heading">Propotion of server ideal time: </h1>
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats">
                <Card.Title as="h4">{PITCal?PITCal:"--"}<span className="units">{units}</span></Card.Title>
